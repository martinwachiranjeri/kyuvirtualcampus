  ...
  <div class="container">
    <header>
      ...
      <nav class="navbar">
        ...
        <a href="onlineide.php">Online IDE</a>
    ...
    <!-- ----------------------------------------OnlineIDE JavaScript------------------------------------- -->


    <div class="OnlineIDE">
      <br>
      <br>
      <iframe style='max-width:100%; border: none' height=600 width=100% src=https://www.interviewbit.com/embed/snippet/bb6b69f724c13418ef5b title='Interviewbit Ide snippet/bb6b69f724c13418ef5b' loading="lazy" allow="clipboard-write" allowfullscreen
    ...
    <section class="footer">
      ...
      <div class="box-container">
        ...
        <div class="box">
          <h3>quick links</h3>
          <a href="../index.php">Home</a>
          <a href="onlineide.p">Online IDE</a>
          <a href="../programming/programming.php">Programming</a>
          <a href="../app_dev/app_dev.php">App-dev</a>
          <a href="../web_dev/web_dev.php">Web-dev</a>
          <a href="../courses.php">Courses</a>
